...
public class GameControl : MonoBehaviour
{
    ...
    void EndGame(string winner)
    {
        ...
        GameObject AIcontrol = GameObject.Find("AI");

        /*
        if (AIcontrol.GetComponent<DadAlgNum1>())
            Destroy(AIcontrol.GetComponent<DadAlgNum1>());
        if (AIcontrol.GetComponent<DadAlgNum2>())
            Destroy(AIcontrol.GetComponent<DadAlgNum2>());
        */
